		...
		<>
			<section className="py-24">
				<div className="container max-w-5xl text-center">
					...
					<button
						type="button"
						className="mt-10 bg-indigo-500 text-white font-medium rounded-lg h-14 px-6 text-lg inline-flex items-center justify-center hover:bg-indigo-600 transition-all"
					>
						Rejoindre les Indie Founders
					</button>
				</div>
			</section>
		</>
